...
assert_defined({ber,decode_octet_string,3}) -> ok;
...
[{ber,match_and_collect,2}];
dependencies({ber,decode_octet_string,3}) ->
[{ber,check_restricted_string,3},{ber,match_and_collect,2}];
...
[{ber,encode_bit_string_named,4},{ber,encode_unnamed_bit_string,2}];
dependencies({ber,encode_named_bit_string,4}) ->
[{ber,encode_bit_string_named,4},{ber,encode_unnamed_bit_string,3}];
